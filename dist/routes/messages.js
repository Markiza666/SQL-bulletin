...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const subscriptionCheck = await pool.query('SELECT COUNT(*) FROM subscriptions WHERE user_id = $1 AND channel_id = ANY($2)', [user_id, channel_ids]);
        ...
        const messageResult = await pool.query('INSERT INTO messages (content, user_id) VALUES ($1, $2) RETURNING id', [content, user_id]);
